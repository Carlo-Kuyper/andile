...
const CoffeeSolid = (props) => (
  <svg
    ...
    style={{
      enableBackground: "new 0 0 511.664 511.664",
    }}
    xmlSpace="preserve"
    {...props}
  >
